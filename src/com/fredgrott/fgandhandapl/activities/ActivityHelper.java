...
import com.fredgrott.fgandhandapl.app.FGAndHandApp;
import com.fredgrott.fgandhandapl.dialogs.IDialogClickListener;
import com.fredgrott.fgandhandapl.execption.*;
import com.fredgrott.fgandhandapl.support.DiagnosticSupport;
import com.fredgrott.fgandhandapl.support.IntentSupport;
...
public class ActivityHelper {
    ...
    public static AlertDialog newErrorHandlerDialog(final Activity activity, String dialogTitle,
        ...
        if (error instanceof IResourceMessageException) {
            screenMessage = activity.getString(((IResourceMessageException) error)
    ...
    public static <T> Dialog newListDialog(final Activity context, String dialogTitle,
            final List<T> elements, final IDialogClickListener<T> listener,
    ...
    static void handleApplicationClosing(final Context context, int keyCode) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            if (currentTask.topActivity.equals(currentTask.baseActivity)
                ...
                FGAndHandApp application  = (FGAndHandApp) context
